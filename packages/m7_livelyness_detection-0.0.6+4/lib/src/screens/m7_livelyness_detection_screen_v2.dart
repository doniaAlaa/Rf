...
class M7LivelynessDetectionScreenV2 extends StatefulWidget {
  ...
  @override
  State<M7LivelynessDetectionScreenV2> createState() => _M7LivelynessDetectionScreenAndroidState();
}

class _M7LivelynessDetectionScreenAndroidState extends State<M7LivelynessDetectionScreenV2> {
  ...
  void _detect({
    ...
    switch (step) {
      ...
      case M7LivelynessStep.turnLeft:
        const double headTurnThreshold = -30;
      ...
      case M7LivelynessStep.turnRight:
        ...
        break;
      case M7LivelynessStep.turnLeft:
        const double headTurnThreshold = 20;
            ...
            ? CameraAwesomeBuilder.custom(
                ...
                builder: (state, previewSize, previewRect) {
                  ...
                  return M7PreviewDecoratorWidget(
                    ...
                    detectionColor: _steps[_stepsKey.currentState?.currentIndex ?? 0].detectionColor,
                  );
                },
