...
class CameraImageContainer extends BaseImageContainer {
  ...
  TensorBuffer getTensorBuffer(int dataType) {
    throw UnsupportedError('Converting CameraImage to TensorBuffer is not supported.');
  }
  ...
  @override
  Image get image => throw UnsupportedError('Converting CameraImage to Image is not supported.');
