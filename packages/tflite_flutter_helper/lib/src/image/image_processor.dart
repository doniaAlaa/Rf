...
class ImageProcessor extends SequentialProcessor<TensorImage> {
  ...
  /// image.
  ui.Rect inverseTransformRect(
      ui.Rect rect, int inputImageHeight, int inputImageWidth) {
    ...
    return ui.Rect.fromLTRB(min(p1.x, p2.x) as double, min(p1.y, p2.y) as double,
