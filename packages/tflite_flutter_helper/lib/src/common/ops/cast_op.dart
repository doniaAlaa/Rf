...
class CastOp implements TensorOperator {
  ...
  CastOp(int destinationType) {
    SupportPreconditions.checkArgument(
        destinationType == TfLiteType.kTfLiteUInt8 || destinationType == TfLiteType.kTfLiteFloat32,
        errorMessage: "Destination Type " + destinationType.toString() + " is not supported");
