...
//      _employeeId = int.parse(loginResult['id']);
//      _employeeName = loginResult['nameEn'];
//
//      _faceRequired = loginResult['faceRequired'];
//      // _faceRequired = false;
//      _deviceId = loginResult['macAddress'];
//    }
//
//
//
...
//     if(loginResult['faceRequired'] == true){
...
//     _presenter.getEmployeeArray(endpoint, companyId, _employeeId, _employeeName);
//
