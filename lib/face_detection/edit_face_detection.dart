...
class EditFaceDetection extends StatefulWidget {
  final String endpoint;
  final String companyId;
  final dynamic businessUnitResult;
  final dynamic loginResult;

  const EditFaceDetection(
      {super.key,
  ...
  @override
  State<EditFaceDetection> createState() => _ControlPanelPageState();
}

class _ControlPanelPageState extends State<EditFaceDetection> implements ControlPanelContract {
  ...
  void _initFaceDetectionValues() {
    print('widget.endpoint${_employeeId}');
  ...
  Future<void> _register() async {
    print('yesRegister${_faceRequired}');
