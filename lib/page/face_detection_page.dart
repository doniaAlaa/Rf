...
class FaceDetectionPage extends StatefulWidget {
  ...
  const FaceDetectionPage({super.key, required this.config});
  ...
  void _detect({
    ...
    switch (step) {
      ...
      case M7LivelynessStep.turnLeft:
        ...
        if ((face.headEulerAngleY ?? 0) < (headTurnThreshold?.rotationAngle ?? -25)) {
          _startProcessing();
     ...
     //       case M7LivelynessStep.turnUp:
      ...
      case M7LivelynessStep.turnLeft:
       //     case M7LivelynessStep.turnDown:
